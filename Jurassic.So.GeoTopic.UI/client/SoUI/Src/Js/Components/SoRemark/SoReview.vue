        ...
        <div class="comment-cont comment-data">
            ...
            <div class="oper cl">
                ...
                <span class="oper-hide">
                    <span v-if="status">
                        <a  @click="onPra" style="color:royalblue">
                            <span class="glyphicon glyphicon-thumbs-up"></span> 赞(<em>{{praise}}</em>)
                        </a>
                    </span>
                    <span v-else>
                        <a  @click="onPra"  style="color:grey">
                            <span class="glyphicon glyphicon-thumbs-up"></span> 赞(<em>{{praise}}</em>)
                        </a>
                    </span>
                </span>
...
<script>
    ...
    export default {
        ...
        created:function(){
            this.premarklist=this.initModel();
            this.praise=this.remarkdata.praiseUsers.length;
        },
        watch:{
            remarkdata:function () {
                this.premarklist=this.initModel();
                this.status=this.praiseFilter();
                this.praise=this.remarkdata.praiseUsers.length;
            }
        },
        components: {
