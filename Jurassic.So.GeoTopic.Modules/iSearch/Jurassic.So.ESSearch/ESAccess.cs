...
namespace Jurassic.So.Search.ES
{
    ...
    public class ESAccess<T> where T : class
    {
        ...
        private static readonly string EsUri = ConfigurationManager.AppSettings["es_uri"];
        private static readonly string EsType = ConfigurationManager.AppSettings["es_type"];
        private static readonly string EsIndex = ConfigurationManager.AppSettings["es_index"];
