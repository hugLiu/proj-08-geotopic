...
namespace Jurassic.So.GeoTopic.Database.EntityFramework
{

    public abstract class EntityFrameworkRepository<TEntity> : IRepository<TEntity>, IDisposable
        where TEntity : class
    {
        ...
        {
            _context = context;
            this.Store = context.Set<TEntity>();
        }

        /// <summary>实体集合</summary>
        protected DbSet<TEntity> Store { get;private set; }
        /// <summary>
        /// 查询接口
        /// </summary>
        /// <returns></returns>
        ...
        public virtual void Add(TEntity entity, bool submit = true)
        {
        ...
        public TEntity Attach(TEntity entity, params object[] keyValues)
        {
            try
            {
                return this.Store.Attach(entity);
            }
            catch (InvalidOperationException)
            {
                var oldEntity = this.Store.Find(keyValues);
                if (oldEntity == null) throw;
        ...
        /// </summary>
        /// <param name="entity"></param>
        public virtual void Update(TEntity entity, bool submit = true)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public virtual void Delete(TEntity entity, bool submit = true)
        {
        ...
        {
            return this.Store.Find(new object[] { key });
        }
